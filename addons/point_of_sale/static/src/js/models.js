...
exports.PosModel = Backbone.Model.extend({
    ...
    push_and_invoice_order: function (order) {
        var self = this;
        // Promesa para retrasar la ejecución con un timeout
        var delayExecution = new Promise(function (resolve) {
            setTimeout(resolve, 3000);  // 2000 ms (2 segundos) de retraso
        });
        return delayExecution.then(function () {
